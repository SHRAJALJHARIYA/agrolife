          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                         <img class="images1" src=" testphoto.jpg" height="500px" width="1350px" alt=".x.">
                         <div class="time"></div>
                    </div>
                    <div class="carousel-item active">
                         <img class="images1" src="veg1.jpg" height="500px" width="1350px" alt="...">
                    </div>
                    <div class="carousel-item">
                         <img class="images1" src="veg2.jpg" height="500px" width="1350px" alt="...">
                    </div>
               </div>
          </div>
     </div>
