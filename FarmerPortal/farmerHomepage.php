 ...
 <body>
      ...
      <body>   
           ...
           <div class="row h
           eaderrow header-bottom" style="text-align:center;">
     ...
     <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
               <div class="carousel-item">
                    <img class="d-block w-100" src="peakpx3.jpg" alt="Third slide">
               </div>
               <div class="carousel-item active">
                    <img class="d-block w-100" src="peakpx.jpg" alt="First slide">
               </div>
               <div class="carousel-item">
                    <img class="d-block w-100" src="peakpx2.jpg" alt="Second slide">
               </div>
          </div>
...
@include'../recipe-page/r1/index.php';
