...
<div class=" flex-row-reverse right ">
    ...
    <div class="text-success  login">Login</div>
       ...
       <div class="card">
            ...
            <div class="card-body">
                 <h4 class="card-title text-success text-center font-weight-bold"> Your Order Has been placed</h4>
                 <h5 class="card-text text-center">Thankyou For Shopping With Us.</h5>
                 <br>
                 <h4 class="card-header text-success text-center font-weight-bold">
                    ...
                    for ($i = 0; $i < 1; $i++) {
                         ...
                         echo "your product id is ". $random_string . '<br>';
                    }
                    ?>
