                        ...
                        <div class="row">
                                <div class="col-md-12 ">
                                    ...
                                    <span>
                                        ...
                                        <a href='   https://forms.gle/DVaL153tuy1eDYL2A' class='btn btn-warning btn-btn-lg border-secondary  chat' style='color:black;padding:2px;'><b>Report </b></a>
                                    </span>
        ...
        <div class="row BigBox">
            <div class='col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4'>
                <div class='card pb-1 pl-1 pr-1 pt-0' style='height:542px'>
                    <br>
                    <div class='mt-0'><b>
                        <h4><img src='iconsmall.png' style='width: 28px; margin-bottom:  10px;'>Ratan ki coffee
                        </b></h4>
                    </div>
                    ...
                    <div class='card-body pb-0'>
                        <div class='row'>
                            <div class='col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12'>
                                <div class='input-group mb'>
                                    <div class='input-group-prepend'>
                                        <h5 class='card-title font-weight-bold'>Coffee Beans</h5>
                                    </div>
                                </div>
                            </div>
                            <div class='col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12'>
                        ...
                        <p class='card-text mb-2 font-weight-bold'>PRICE:- 50 Rs/kg</p>
                        <div class='row'>
